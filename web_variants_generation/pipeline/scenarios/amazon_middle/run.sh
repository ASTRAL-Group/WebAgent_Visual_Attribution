...
node "$SCENARIO_DIR/generate_variations.js" --snapshot "$REPO_ROOT/$SCENARIO_DIR/source/top_10_products.html" --output web_variants_generation/data/amazon_middle/html
